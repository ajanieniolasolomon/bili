...
import '../model/lunch_model.dart';
import '../utili/page_indicator.dart';
...
class _LunchState extends State<Lunch> with TickerProviderStateMixin  {
                ...
                return AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    ...
                    return Column(
                      ...
                      children: <Widget>[
                        Image.asset(page.imageUrl,height: MediaQuery.of(context).size.height*0.6,),
                        Container(
